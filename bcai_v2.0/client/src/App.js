...
//add downloadEvent() function to download the byte array from ipfs to the open socket (socket is generated by server.js found in ML folder)
//convert notifications with dataID and resultID to last twice as long 
//edit notifications that used to show address of requester or provider to now show the dataID and resultID 
//Add showId() function to easily display the dataID and resultID as well as download button for each
...
class App extends Component {
  ...
  componentWillMount = async () => {
    try {
      ...
      this.setState({ web3, accounts, myContract: instance, myAccount: accounts[0], events: [] , socket })
...
/*  //call-back style code only for reference [deprecated]
  ...
  */
  ...
  IPFSDownload = async(event) => {
    ...
    if(this.state.dataTag === "data"){
      tag = this.state.dataID
    }
    if(this.state.dataTag === "result"){
      tag = this.state.resultID
    }
    return new Promise((resolve, reject) => {
